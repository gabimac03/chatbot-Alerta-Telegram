...
1: {
  ...
  pdf: "/recursos/modulos/Modulo 1 - Info - TxD.pdf", // 🔹 nuevo campo
  contenidoNarrativo: `

    <h2>Video: Protección de la Información</h2>
      <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/851CLZcqoXE?si=qZW0OYgkzKnVzj4g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
        </iframe>
      </div>
...
2: {
  ...
  pdf: "/recursos/modulos/Modulo 2 - Correo - TxD.pdf", // 🔹 nuevo campo
  contenidoNarrativo: `

      <h2>Video: Correo electrónico seguro</h2>
      <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/M1DwPq2-5WU?si=8LfTPyHLJkfwCOoK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
        </iframe>
      </div>
